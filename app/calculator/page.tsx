      ...
      <Tabs defaultValue="add-subtract" className="space-y-4">
        ...
        <TabsContent value="convert" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              <Label>From</Label>
              <Select value={fromUnit} onValueChange={(value: string) => setFromUnit(value as "hours" | "minutes" | "seconds")}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-2">
              <Label>To</Label>
              <Select value={toUnit} onValueChange={(value: string) => setToUnit(value as "hours" | "minutes" | "seconds")}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
